...
static void test_label_map_functionality(mmap_assets_handle_t assets_handle)
{
    ...
    // gfx_label_set_font(label_obj, (gfx_font_t)&font_16);

    gfx_label_set_text(label_obj, "AAA乐鑫BBB乐鑫CCC乐鑫CCC乐鑫BBB乐鑫AAA");
    // gfx_label_set_text(label_obj, "AAAA上海浦东乐鑫信息技术有限公司");
    // gfx_label_set_text(label_obj, "12345678900987654321");
...
static void test_label_freetype_functionality(mmap_assets_handle_t assets_handle)
{
    ...
    // Wait for display
    vTaskDelay(pdMS_TO_TICKS(2000 *100));
...
static void test_multiple_objects_interaction(mmap_assets_handle_t assets_handle)
{
    ...
    // Configure animation
    const void *anim_data = mmap_assets_get_mem(assets_handle, 0);
    size_t anim_size = mmap_assets_get_size(assets_handle, 0);
...
void test_label_freetype_functionality_1(void)
{
    // Initialize display and graphics system
    mmap_assets_handle_t assets_handle = NULL;
    esp_err_t ret = init_display_and_graphics("assets_8bit", MMAP_TEST_ASSETS_FILES, MMAP_TEST_ASSETS_CHECKSUM, &assets_handle);
...
void test_label_map_functionality_1(void)
{
    // Initialize display and graphics system
    mmap_assets_handle_t assets_handle = NULL;
    esp_err_t ret = init_display_and_graphics("assets_8bit", MMAP_TEST_ASSETS_FILES, MMAP_TEST_ASSETS_CHECKSUM, &assets_handle);
...
void app_main(void)
{
    ...
    // unity_run_menu();
    test_label_map_functionality_1();
    // test_label_freetype_functionality_1();
}